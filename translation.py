class Translation(object):
    START_TEXT = """Hi {},
I'm Akash-URL-Uploader!
You can upload HTTP/HTTPS direct link, Using this bot!
If You face any Problem contact @PrimeAkash 🇧🇩
...
URL | filename | username | password"""
    ...
    AFTER_SUCCESSFUL_UPLOAD_MSG = "Thanks for using @AkashUrlUploaderBot)"
...
If bot didn't respond, contact @PrimeAkash 🇧🇩"""
